...
public class OrderServiceImpl implements OrderService {
     ...
     */
    @Override
    public void updateStatus(String outtradeno, String paytime, String transcationid) {
        //时间转换工具对象
        ...
        order.setTransactionId(transcationid);//交易流水号
    ...
    public void add(Order order){
        ...
        //获取勾选的商品ID,需要下单的商品，将要下单的商品从购物车中移除
        for (Long skuid: order.getSkuIds()) {
            orderItemList.add((OrderItem) redisTemplate.boundHashOps("Cart_" + order.getUsername()).get(skuid));
        ...
        order.setPayMoney(totalMoney);  //实付金额(存在优惠就不一样)
