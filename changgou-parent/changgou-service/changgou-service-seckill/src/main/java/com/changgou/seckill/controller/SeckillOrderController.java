...
public class SeckillOrderController {
    ...
    public Result add(@RequestParam(value = "time") String time, @RequestParam(value = "id") Long id){
        try {
            //用户登录名
            String username = "唐3";
    ...
    public Result add1(@RequestParam(value = "time") String time, @RequestParam(value = "id") Long id,@RequestParam(value = "username") String username){
        try {
            //用户登录名
//            String username = "唐3";

            //调用Service增加订单
            Boolean bo = seckillOrderService.add1(id, time, username);
